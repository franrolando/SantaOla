  ...
  <main class="container" style="width: 90%;">
    ...
    <div class="content" >
      <div id="comments" style="align-items:center;">
        <br>
        <br>
        <h2>Ingresar Sponsor</h2>
        <br>
        <br>
        <form action="<?php echo FRONT_ROOT;?>Sponsor/Add" method="post" enctype="multipart/form-data" style="background-color: #EAEDED;padding: 2rem !important;">
          <table>
            <thead>
              <tr>
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="desc" id="exampleInputPassword1" placeholder="Ingrese la descripcion del producto">
                </div>
                <div class="form-group">
                  <label for="exampleInputPassword1">DNI</label>
                  <input type="text" class="form-control" name="precio" id="exampleInputPassword1" placeholder="Ingrese el precio del producto">
                </div>
                <div class="form-group">
